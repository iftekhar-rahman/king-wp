...
if ( ! function_exists( 'king_setup' ) ) :
	...
	function king_setup() {
		...
		register_nav_menus(
			array(
				'primary-menu' => esc_html__( 'Primary Menu', 'king' ),
			)
		);
...
function king_custom_posts(){
	register_post_type('hero-section', array(
		'labels' => array(
            'name'             => __('Hero Section', 'halim'),
            'singular_name'    => __('Hero Section', 'halim')
        ),
        'public' => true,
        'supports'  => array('title', 'editor', 'thumbnail', 'custom-fields')
	));
}
add_action( 'init', 'king_custom_posts' );
...
function king_scripts() {
	...
	wp_enqueue_style( 'fontawesome', get_template_directory_uri() . '/assets/css/all.fontawesome.min.css', array(), _S_VERSION );
	...
	wp_enqueue_style( 'main-css', get_template_directory_uri() . '/assets/css/style.css', array(), _S_VERSION );

	wp_enqueue_style( 'king-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'king-style', 'rtl', 'replace' );

	// JS
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.bundle.min.js', array('jquery'), _S_VERSION, true );
	wp_enqueue_script( 'nice-select', get_template_directory_uri() . '/assets/js/jquery.nice-select.min.js', array('jquery'), _S_VERSION, true );
	...
	wp_enqueue_script( 'aos', get_template_directory_uri() . '/assets/js/aos.js', array('jquery'), _S_VERSION, true );
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/assets/js/slick.min.js', array('jquery'), _S_VERSION, true );
	wp_enqueue_script( 'slickimagesloaded', get_template_directory_uri() . '/assets/js/imagesloaded.pkgd.min.js', array('jquery'), _S_VERSION, true );
